...
const form = useForm({
    tanggal: props.pengeluaran.tanggal,
    catatan: props.pengeluaran.catatan,
    jumlah: props.pengeluaran.jumlah,
    status: props.pengeluaran.status,
});

const submit = () => {
    form.put(route('pengeluaran.update', props.pengeluaran.id));
};
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="fas fa-pencil-alt mr-2"></i> Edit Data Pengeluaran
            </h2>
        </template>
